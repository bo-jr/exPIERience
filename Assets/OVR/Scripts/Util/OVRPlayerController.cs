...
public class OVRPlayerController : MonoBehaviour
{
	...
	/// </summary>
	public float BackAndSideDampen = 1.0f;
   ...
   public GameObject ControlsDisplay;
	...
	public virtual void UpdateMovement()
	{
		...
		// Reduces movement speed if going diagonally
		MoveScale = 1.0f;
		...
		*/
		...
		//SimulationRate is framerate, Time.deltaTime is time since last update
		...
		//From what I can tell, the below lines make movement relative to point of view
		...
		// Just frills - seems like immediate rotations one way or the other based off of controller pushes
		/*
